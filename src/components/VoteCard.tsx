...
export const VOTING_INFO_LIST: VotingInfo[] = [
    ...
    { title: "음중 · STAGE M PICK", description: "🏆 1위 시, STAGE M PICK 트로피 수여", method: "Muniverse 어플(권장) 또는 웹사이트,\n무제한 투표, 무료/유료 재화, 다계정 가능", dueDate: new Date('2026-03-12T11:00:00+09:00'), guideImgPath: "/guide-vote-musiccore.png", votingLink: "https://www.muniverse.io/votes/e9fc0a7c-9061-41ce-8ec1-973ba8835e9c", isImportant: false },
