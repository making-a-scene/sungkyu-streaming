...
const zh: FanartFormMessages = {
  ...
  uploadCta: '上传图片',
  uploadHint: '最多可选择1张',
  messagePlaceholder: '如果有想随同人画一起传达的留言,请写在这里。',
  writeComplete: '完成',
  backHome: '返回:首页',
  consentTitle: '资料提交及使用须知',
  consentIntro: [
    '为了制作将在LV4 FINAL IN BUSAN演出期间转交给艺人的留言册,我们正在征集你的同人画与留言。',
    '你提交的资料将用于留言册制作,不会用于该目的以外的用途。',
  ],
  consentCautionTitle: '提交资料时的注意事项',
  consentCautions: [
    '请只提交本人原创的同人画。不得提交未经授权使用或编辑他人作品的图片。',
