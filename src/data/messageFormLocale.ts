...
const ko: MessageFormMessages = {
  ...
  consentIntro: [
    'LV4 FINAL IN BUSAN 콘서트에서 진행될 영상 이벤트와 메시지북 제작을 위해 시민둥이 여러분의 메시지와 사연을 모집합니다.',
  ...
  consentOutro: [
    '제출된 메시지는 위 목적 범위 내에서만 사용되며, 팬이벤트 영상 및 메시지북 제작 완료 후 제출된 원본 자료는 일괄 삭제됩니다.',
...
const en: MessageFormMessages = {
  ...
  letterPlaceholder:
    'Share the moments when Sungkyu gave you strength, the times you felt grateful to him, and everything you\'d like to say to cheer on what\'s ahead!',
  writeComplete: 'Done',
  backHome: 'Back to Home',
  consentTitle: 'Submission & Use of Materials',
  consentIntro: [
    'For the video event and message book at the LV4 FINAL IN BUSAN concert, we\'re collecting your messages and stories.',
  ...
  consentOutro: [
    'Submitted messages will be used only within the scope above, and the original files will be deleted in full once the fan event video and message book are complete.',
  ...
  emailTitle: 'Would you like to receive excerpts from the final fan event content? (optional)',
  emailDesc: 'After the event, we\'ll email you part of the fan event video and part of the message book.',
  emailPlaceholder: 'Email address',
  emailConsentTitle: 'Email Collection & Use',
  emailConsentItems: [
    'Collected: email address',
    'Purpose: delivering part of the fan event video and part of the completed message book',
    'Retention: kept for 7 days after delivery, then deleted',
  ],
  emailConsentCheck: 'I agree to the collection and use of my email address to receive part of the fan event video and part of the completed message book.',
  back: 'Back',
  submit: 'Submit',
...
const zh: MessageFormMessages = {
  ...
  letterPlaceholder:
    '从圣圭那里获得力量的瞬间、想向圣圭表达感谢的时刻、为今后活动加油或想要传达的话，都请尽情写下来吧！',
  writeComplete: '完成',
  backHome: '返回首页',
  consentTitle: '资料提交及使用须知',
  consentIntro: [
    '为了在LV4 FINAL IN BUSAN演唱会上进行的影像活动与留言册制作，我们正在征集你的留言与故事。',
  ...
  consentOutro: [
    '提交的留言仅在上述范围内使用，粉丝活动影像及留言册制作完成后，提交的原始资料将被一并删除。',
  ...
  emailTitle: '想收到完成后的应援影像片段和部分留言册吗？（选填）',
  emailDesc: '活动结束后，我们会通过邮件向你发送粉丝活动影像片段及部分留言册。',
  emailPlaceholder: '邮箱地址',
  emailConsentTitle: '邮箱收集及使用须知',
  emailConsentItems: [
    '收集项目：邮箱地址',
    '收集目的：提供粉丝活动影像片段及部分完成后的留言册',
    '保存期限：内容发送后保存7天，随后删除',
  ],
  emailConsentCheck: '我同意为接收完成后的影像片段和部分留言册而收集和使用我的邮箱地址。',
  back: '返回',
  submit: '提交',
  submitting: '提交中…',
  doneTitle: '提交已完成。',
...
const ja: MessageFormMessages = {
  ...
  letterPlaceholder:
    'ソンギュのおかげで力をもらえた瞬間、ソンギュに感謝した瞬間、これからの活動への応援や伝えたかった言葉を、すべてお寄せください！',
  writeComplete: '完了',
  backHome: 'ホームに戻る',
  consentTitle: '資料の提出および利用案内',
  consentIntro: [
    'LV4 FINAL IN BUSANコンサートで行われる映像イベントとメッセージブック制作のため、皆さんのメッセージとエピソードを募集します。',
  ...
  emailTitle: '完成したファンイベント映像の一部とメッセージブックの一部を受け取りますか？（任意）',
  emailDesc: 'イベント終了後、ファンイベント映像の一部とメッセージブックの一部をメールでお送りします。',
  emailPlaceholder: 'メールアドレス',
  emailConsentTitle: 'メールアドレスの収集および利用案内',
  emailConsentItems: [
    '収集項目：メールアドレス',
    '収集目的：ファンイベント映像の一部およびメッセージブックの一部の提供',
    '保有期間：内容送付後7日間保管し、その後削除',
  ],
  emailConsentCheck: 'ファンイベント映像の一部およびメッセージブックの一部提供のためのメールアドレスの収集および利用に同意します。',
  back: '戻る',
  submit: '提出する',
  submitting: '提出中…',
  doneTitle: '提出が完了しました。',
