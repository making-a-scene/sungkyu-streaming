            ...
            <main className="main-content">
                {selectedTab === 0 && (
                    <><img src={process.env.PUBLIC_URL + '/melon-download-guide.png'} alt="guide"
                        ...
                        src={process.env.PUBLIC_URL + '/melon-mv-download-guide.png'} alt="guide"
                        style={{width: '100%', maxWidth: '880px', display: 'block'}}/><img
                ...
                {selectedTab === 2 && (
                    <><img src={process.env.PUBLIC_URL + '/bugs-music-download-guide.png'} alt="guide"
                           style={{width: '100%', maxWidth: '880px', display: 'block'}}/><img
                        src={process.env.PUBLIC_URL + '/bugs-mv-download-guide.png'} alt="guide"
                        style={{width: '100%', maxWidth: '880px', display: 'block'}}/></>
                )}
                {selectedTab === 3 && (
